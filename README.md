...
| `FinalProject/` | **ISM 6251 Spring 2026** | Final Project — undergraduate and graduate project guides, 30 scenario folders (train/test/holdout features + business context), and templates |
...
- `undergraduate-project-guide.md` — spec for the individual undergraduate project (scenarios 01–20)
- `graduate-project-guide.md` — spec for the team-based graduate multi-modal project (scenarios 21–30)
- `cases/NN-.../` — one folder per scenario containing `scenario.md` (business context + cost structure), `train.csv`, `test.csv`, and `holdout_features.csv`
- `templates/` — solution exemplar, executive-summary template, response-calibration examples, and a pre-submission validator
